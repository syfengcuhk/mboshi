...
# To do: leverage OOD transcripts from one monolingual ASR  and mboshi speech data to train an SAT-GMM-HMM model, with which alignments are created.
...
expdir_root=exp/gmm_discophone_label/${lang_name}_${LMTYPE}/$full_train_set
lang=$discophone_root/data/lang_combined_test
data_dir=data_plus_discophone_transcripts/${lang_name}_${LMTYPE}/acwt${disco_acwt}/$full_train_set # to create data_plus_discophone_transcripts/ dir, run disco_mono_labeling.sh
